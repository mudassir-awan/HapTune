...
class App(QMainWindow):
    ...
    def initUI(self):
        ...
        # (now add all other things to main_layout)
    ...
    def setup_controls(self, controls_layout):
        ...
        # New Buttons for Axis Range and Vibration
